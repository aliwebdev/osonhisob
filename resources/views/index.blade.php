...
<script>
  ...
  if (userinput == username && userpass == password) {
    ...
    document.getElementById("error").innerHTML='<div class="alert alert-danger" role="alert" id="error">Parol yoki username kiritilmadi !</div>';
    
  } 
  else {
    document.getElementById("error").innerHTML='<div class="alert alert-danger" role="alert" id="error">Parol yoki username xato !</div>';
  }
}
</script>
</body>
