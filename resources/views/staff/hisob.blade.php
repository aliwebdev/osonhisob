...
<div class="card-body">
              ...
              <table class="table table-bordered border-dark">
                ...
                <a href="{{route('staff.create')}}" class="btn btn-primary mb-3" style="margin-left: 880px;">Qo'shish</a>
                <tbody>
                @foreach ($staff as $data)
                  <tr align="center">
                    ...
                    <td>
                      <a href="{{ route('staff.edit',['staff' => $data->id]) }}" class="btn btn-success"><i class="bi bi-pen"></i></a>
                    </td>
                  </tr>
                  @endforeach
                </tbody>
